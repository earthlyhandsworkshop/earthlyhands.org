...
| `/experiments/four-way-room-nav/` | Literal four-direction movement-control specimen | Grainline | Yes | No source geometry claimed; button positions are interface directions only | Tests room movement grammar for future Prose Map/public use |
