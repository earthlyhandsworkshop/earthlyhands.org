...
| `/experiments/four-way-room-nav/` | MCR 879 — Robert Bell evidence field; navigation experiment | Grainline carrying source-facing Bell–McKinney work | Yes | Moves among 1901 testimony, older Article XIV record body, 1846 patent / 1902 Office use, and 1907 rehearing sequence; directional position is interface only | Replaces first movement toy in place; tests subtle room navigation on consequential research |
